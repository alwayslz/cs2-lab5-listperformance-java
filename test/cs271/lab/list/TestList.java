...
public class TestList {
	...
	public void testSizeNonEmpty() {
		...
		assertEquals(77, (int)list.get(0));
	}
...
//		fail("Not yet implemented"); // remove this line when done
	...
	public void testAddMultiple2() {
		...
		assertEquals(44, (int)list.get(2));
		assertEquals(77, (int)list.get(3));
...
//		fail("Not yet implemented"); // remove this line when done
	...
	public void testAddAll() {
		...
		list = Arrays.asList(33,77,44,77,55,77,66);
		assertEquals(7, list.size());
		...
		assertEquals(77, (int)list.get(5));
		assertEquals(66, (int)list.get(6));
	}
